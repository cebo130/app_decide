...
class BoardView extends StatefulWidget {
  ...
  const BoardView({required this.angle, required this.current, required this.items});
    ...
    return Transform.rotate(
      ...
      child: Container(
        ...
        child: ConstrainedBox(
          ...
          child: Text(luck.asset,style: TextStyle(fontWeight: FontWeight.bold,color: Colors.blueGrey),),//Image.asset(luck.asset),
        ),
      ),
    );
  }
